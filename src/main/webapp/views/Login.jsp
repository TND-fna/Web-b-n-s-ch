                        ...
                        <div id="loginForm"
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-12">
                                    <form name="loginForm" class="loginForm" action="loginAccount"method="post">
                                    <!--Hệ thống kiểm tra thông tin đăng nhập của người dùng qua Servlet loginAccount-->

                                    <div class="form-group">
                                        <input type="text" class="form-control email" name="userName" placeholder="Tên tài khoản">
